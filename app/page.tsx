...
const profileBubbleLayout = [
  [72.9, 8, 1.42, 64.3, 22.8], [16.4, 78.8, .72, 71, 30.5], [77.1, 46.2, 1.08, 54, 8.4],
  [79.6, 18.3, .64, 11.1, 20.9], [75.1, 68.2, 1.34, 28, 19.7], [7, 79, .82, 86.5, 53.3],
  ...
  [12.9, 24.8, 1.22, 43.8, 15.9], [87.9, 66, .8, 10.7, 7.3], [4.9, 31.9, 1.05, 18.5, 88.6],
  [50.1, 2.5, .86, 82.3, 89], [6.8, 50.7, 1.4, 13.3, 63.6], [72.8, 39.1, 1.15, 10.5, 42.7],
  [83.2, 8.3, .9, 14.2, 29], [93.7, 87, 1.02, 75.5, 17.6], [20.5, 65.1, .62, 84, 14.8],
  [5.9, 15, 1.18, 17.3, 39.1], [19.8, 72.9, .72, 9.6, 75.5], [84.2, 88.3, .64, 84, 79.9],
  [91.8, 53.6, 1, 82.7, 64.8], [8.5, 64.3, .6, 69.9, 4.9], [8.7, 5, 1.25, 84, 67.7],
