...
const profileBubbleLayout = [
  [22.7, 16.5, 1.42, 18.5, 19.4], [33.8, 13.8, .72, 35, 21.6], [46.8, 18.3, 1.08, 53, 18.7], [62.4, 14.7, .64, 72.5, 22.3],
  [76.7, 21, 1.34, 83, 20.2], [26, 24.6, .82, 22.3, 25.2], [40.9, 22.8, 1.15, 44.8, 24.5], [55.2, 27.3, .7, 67.3, 26.6],
  [69.5, 24.6, 1.16, 82.3, 28.1], [79.3, 30, 1.1, 17.8, 31], [31.8, 31.8, 1.38, 34.3, 29.5], [48.1, 30, .88, 54.5, 32.4],
  [63, 31.8, .62, 74, 31], [74.7, 32.7, 1.3, 25.3, 35.3], [24, 39.9, 1, 44.8, 34.6], [74.1, 39, 1.22, 65.8, 36.7],
  [20.1, 47.1, .8, 83, 35.3], [77.3, 49.8, 1.05, 18.5, 40.3], [28.6, 54.3, .86, 35, 38.9], [71.5, 56.1, 1.4, 56.8, 41.8],
  [22.1, 61.5, 1.15, 77, 40.3], [76.7, 63.3, .9, 23.8, 45.4], [26.6, 69.6, 1.02, 45.5, 43.9], [72.1, 71.4, .62, 67.3, 46.1],
  [20.8, 77.7, 1.18, 83, 44.6], [77.3, 79.5, .72, 17, 50.4], [27.3, 85.8, .64, 32.8, 49], [73.4, 87.6, 1, 53.8, 51.8],
  [22.7, 93.9, .6, 74.8, 49.7], [78, 95.7, 1.25, 24.5, 54.7], [29.2, 43.5, 1.4, 44.8, 54], [70.8, 44.4, .75, 65, 56.2],
  [24.7, 51.6, 1.1, 82.3, 54], [76, 53.4, .72, 17, 59], [19.5, 66, 1.32, 32.8, 58.3], [77.3, 67.8, .78, 51.5, 60.5],
  [29.2, 74.1, 1.05, 69.5, 58.3], [70.8, 75.9, .68, 83, 60.5], [24.7, 83.1, 1.3, 21.5, 56.9], [77.3, 84.9, .72, 39.5, 59.8],
  [20.1, 91.2, 1.2, 59.8, 56.9], [76.7, 92.1, .82, 78.5, 59],
] as const;
