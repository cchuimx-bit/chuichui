...
const profileBubbleLayout = [
  [60, 14, 1.42, 64.3, 22.8], [16.4, 78.8, .72, 71, 30.5], [77.1, 46.2, 1.08, 54, 8.4],
  ...
  [5.5, 23, 1.22, 43.8, 15.9], [87.9, 66, .8, 10.7, 7.3], [5, 34, 1.05, 18.5, 88.6],
  [31.5, 16, .86, 82.3, 89], [6.8, 50.7, 1.4, 13.3, 63.6], [72.8, 39.1, 1.15, 10.5, 42.7],
  [92, 34, .9, 14.2, 29], [93.7, 87, 1.02, 75.5, 17.6], [20.5, 65.1, .62, 84, 14.8],
  [5.9, 15, 1.18, 17.3, 39.1], [19.8, 72.9, .72, 9.6, 75.5], [84.2, 88.3, .64, 84, 79.9],
  [91.8, 53.6, 1, 82.7, 64.8], [8.5, 64.3, .6, 69.9, 4.9], [92, 15, 1.25, 84, 67.7],
