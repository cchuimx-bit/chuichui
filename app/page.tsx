...
const profileBubbleLayout = [
  [15.9, 16.5, 1.42, 12.2, 12.7], [29.7, 13.8, .72, 32, 16.8], [46, 18.3, 1.08, 53.6, 11.4], [65.5, 14.7, .64, 77, 18.1],
  [83.4, 21, 1.34, 89.6, 14.2], [20, 24.6, .82, 16.8, 23.5], [38.6, 22.8, 1.15, 43.8, 22.2], [56.5, 27.3, .7, 70.8, 26.1],
  [74.4, 24.6, 1.16, 88.8, 28.8], [86.6, 30, 1.1, 11.4, 34.2], [27.3, 31.8, 1.38, 31.2, 31.4], [47.6, 30, .88, 55.4, 36.8],
  [66.3, 31.8, .62, 78.8, 34.2], [80.9, 32.7, 1.3, 20.4, 42.2], [17.5, 39.9, 1, 43.8, 40.9], [80.1, 39, 1.22, 69, 44.7],
  [12.6, 47.1, .8, 89.6, 42.2], [84.1, 49.8, 1.05, 12.2, 51.4], [23.3, 54.3, .86, 32, 48.8], [76.9, 56.1, 1.4, 58.2, 54.2],
  [15.1, 61.5, 1.15, 82.4, 51.4], [83.4, 63.3, .9, 18.6, 60.8], [20.8, 69.6, 1.02, 44.6, 58.1], [77.6, 71.4, .62, 70.8, 62.1],
  [13.5, 77.7, 1.18, 89.6, 59.4], [84.1, 79.5, .72, 10.4, 70.1], [21.6, 85.8, .64, 29.4, 67.5], [79.3, 87.6, 1, 54.6, 72.7],
  [15.9, 93.9, .6, 79.8, 68.8], [85, 95.7, 1.25, 19.4, 78], [24, 43.5, 1.4, 43.8, 76.8], [76, 44.4, .75, 68, 80.8],
  [18.4, 51.6, 1.1, 88.8, 76.8], [82.5, 53.4, .72, 10.4, 86], [11.9, 66, 1.32, 29.4, 84.7], [84.1, 67.8, .78, 51.8, 88.8],
  [24, 74.1, 1.05, 73.4, 84.7], [76, 75.9, .68, 89.6, 88.8], [18.4, 83.1, 1.3, 15.8, 82.1], [84.1, 84.9, .72, 37.4, 87.5],
  [12.6, 91.2, 1.2, 61.8, 82.1], [83.4, 92.1, .82, 84.2, 86],
] as const;
