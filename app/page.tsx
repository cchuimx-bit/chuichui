...
const internshipThoughts = [
  [
    "原本的我原本并不擅长做策略。",
    "当ld把偏策略分析的工作交给我时，我是惶恐的。面对陌生的数据字段和复杂的分析口径，我总担心自己理解得不够准确，害怕一个字段看错、一处解析出现偏差，就会让最后的结论偏离原本的方向。那段时间，我反复核对每一个数字，小心翼翼地写下每一句判断，生怕自己的疏忽会影响后续的工作。",
    "618大促前，ld作为大促poc和我说，希望我成为她的副手，协助她一起完成这次大促。",
    "“副手”两个字让我期待，也让我不安。我不知道自己能不能跟上她的节奏，能不能及时理解每一项策略，又能不能把这些策略准确地传达给达人。但大促没有留给我太多犹豫的时间，我只能一头扎进去。",
    "我开始跟进每一个专项，传达每一轮策略，拜访达人，再一遍遍和达人沟通。很多事情并不会因为策略写得足够清楚，就自然而然地得到想要的结果。我要了解每个达人的情况，理解他们的顾虑，也要想办法让原本停留在文档里的策略，真正落到一次选品、一场直播和一条内容里。",
    "那段时间，我常常盯着后台的数据看。",
    "看着达人的GMV一点点提升，看着大促的完成度一点点接近目标，看着曾经停留在表格里的数字，因为一次次沟通与调整开始发生变化，我忽然有了一种很具体的自豪感。原来我传达过的每一次策略、跟进过的每一个专项、与达人反复确认过的每一个细节，都没有消失。它们散落在大促漫长而忙乱的过程里，最后又一点点汇聚成了真实的结果。",
    "我不知道自己是从什么时候开始喜欢上策略的。",
    "或许是从第一次发现自己的判断得到了数据验证开始，或许是从达人采纳建议后取得提升开始，也或许是从一次次沟通中，我逐渐能够听懂他们没有直接说出口的顾虑开始。",
    "我曾经害怕字段，害怕数据，也害怕自己做出的判断不够准确。可后来，我开始喜欢在复杂的信息里寻找方向，喜欢看着一个模糊的想法被慢慢验证，也喜欢与一个个原本陌生的达人建立联系。",
    "那些最初让我惶恐的事情，后来竟然成了我最愿意反复琢磨、也最舍不得放下的工作……",
  ],
  [
    "本来，这只是一次普普通通的实习。",
    "我按时完成策划、撰写文案、制作海报，跟进活动流程，做好分内的事情，似乎就足够了。",
    "可真正参与其中以后，我才发现，那些在电脑上反复修改的文字和图片，并不会只停留在文件夹里。它们会以企业的名义出现在用户面前，成为许多人认识这个品牌的第一眼。",
    "品牌形象也因此不再是一个抽象的词。它可能是用户看到海报时，愿不愿意多停留几秒；是阅读文案时，能不能准确理解我们想表达的内容；也是与我们取得联系后，是否得到了及时、专业而有分寸的回应。",
    "有时候，一个用词不够准确，一处信息没有交代清楚，或是一条消息回复得太迟，影响的都不只是某项工作的完成度。用户并不知道屏幕后面具体是谁在操作，他们只会把这些细节，当作对这家企业的直接感受。",
    "也是在这个过程中，我开始重新理解活动结案中的那些数字。浏览量、参与人数、转化率当然重要，但用户并不只是表格里不断累加的数字。每一次点击、咨询和反馈的背后，都是一个真实的人。他们带着自己的需求而来，也会根据每一次具体的接触，决定是否继续了解和信任这个品牌。",
    "于是，我开始比以前更在意细节。",
    "写完一句文案，会多想一遍用户能否读懂；发出一张海报前，会重新检查时间、地点和规则；面对咨询时，也会提醒自己，屏幕另一端不是一个等待处理的用户，而是一个正在等待回应的人。",
    "于是，这场原本普普通通的实习，变得郑重而神圣。",
    "它让我第一次如此清晰地感受到。当个人的表达与企业的形象相连，当自己的工作能够抵达真实的人群，再微小的岗位，也值得被认真对待；再平凡的工作，也会因为责任与真诚，而生长出不平凡的意义。",
  ],
  [
    "小吹跌跌撞撞地开始了自己的第一份实习。",
    "现在回头看，那段时间好像是一场关于长大的一场预演。",
    "第一次离开熟悉的环境，一个人租房，一个人生活，一个人处理生活里的琐碎；第一次坐在工位上，面对陌生的任务，尝试着独立完成工作、独立提出想法、独立承担结果。很多事情放在现在看来并没有那么难，但对于当时的我来说，每一次迈出去，似乎都需要鼓起一点勇气。",
    "如果一定要用一个词概括那段经历，我想应该是“独立”。",
    "但这种独立，并不是突然变得无所不能，而是在一次次不确定里，慢慢学会相信自己。",
    "刚入职的时候，其实有很多不安。",
    "记得第一次和ld聊天时，我小心翼翼地说：“其实我有点害怕，害怕自己什么都不懂，也害怕自己做错。”",
    "他说：“不懂和出错都是很正常的。如果你什么都会，我们反而才会觉得奇怪。有什么问题随时问，我们都很愿意教你。”",
    "后来，mt也经常肯定我。她会告诉我，我是她带过最优秀最有想法的实习生，会认真告诉我哪些地方做得很好。",
    "然而在此之前，我一直认为自己平平无奇。",
    "于是可想而知，这些话对于第一次实习的我来说，简直就是莫大的底气。在未来内耗、焦虑、辗转反侧的夜里，这些话也一直支撑着我，让我更加相信自己。",
    "原来，在我还没有学会相信自己的时候，已经有人先看见了我的可能。",
    "第一份实习留给我的，不只是一次工作经历，更是一次重新认识自己的机会。",
    "它让我学会独立生活，独立面对问题，也让我第一次拥有了一种确定感。",
    "我好像真的可以成为一个更好的自己。",
  ],
] as const;
