...
const profileBubbleLayout = [
  [8, 5, 1.42, 8, 2], [25, 2, .72, 30, 5], [45, 7, 1.08, 54, 1], [69, 3, .64, 80, 6],
  [91, 10, 1.34, 94, 3], [13, 14, .82, 13, 10], [36, 12, 1.15, 43, 9], [58, 17, .7, 73, 12],
  [80, 14, 1.16, 93, 14], [95, 20, 1.1, 7, 18], [22, 22, 1.38, 29, 16], [47, 20, .88, 56, 20],
  [70, 22, .62, 82, 18], [88, 23, 1.3, 17, 24], [10, 31, 1, 43, 23], [87, 30, 1.22, 71, 26],
  [4, 39, .8, 94, 24], [92, 42, 1.05, 8, 31], [17, 47, .86, 30, 29], [83, 49, 1.4, 59, 33],
  [7, 55, 1.15, 86, 31], [91, 57, .9, 15, 38], [14, 64, 1.02, 44, 36], [84, 66, .62, 73, 39],
  [5, 73, 1.18, 94, 37], [92, 75, .72, 6, 45], [15, 82, .64, 27, 43], [86, 84, 1, 55, 47],
  [8, 91, .6, 83, 44], [93, 93, 1.25, 16, 51], [18, 35, 1.4, 43, 50], [82, 36, .75, 70, 53],
  [11, 44, 1.1, 93, 50], [90, 46, .72, 6, 57], [3, 60, 1.32, 27, 56], [92, 62, .78, 52, 59],
  [18, 69, 1.05, 76, 56], [82, 71, .68, 94, 59], [11, 79, 1.3, 12, 54], [92, 81, .72, 36, 58],
  [4, 88, 1.2, 63, 54], [91, 89, .82, 88, 57],
] as const;
