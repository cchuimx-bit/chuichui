...
const profileBubbleLayout = [
  [8, 8, 1.42, 11, 3], [27, 4, .72, 33, 7], [46, 14, 1.08, 54, 2], [72, 6, .64, 74, 10],
  [91, 18, 1.34, 91, 17], [15, 27, .82, 18, 14], [40, 23, 1.48, 47, 20], [68, 29, .7, 78, 25],
  [88, 35, 1.16, 9, 29], [4, 42, .68, 28, 27], [29, 45, 1.38, 58, 31], [58, 40, .88, 87, 35],
  [84, 50, .62, 38, 38], [13, 55, 1.5, 75, 44], [40, 59, .76, 20, 48], [69, 57, 1.22, 87, 51],
  [93, 64, .8, 8, 57], [7, 71, 1.05, 28, 61], [25, 78, .66, 77, 58], [51, 72, 1.4, 94, 67],
  [78, 80, .84, 9, 73], [95, 88, 1.18, 31, 76], [12, 91, .74, 83, 72], [37, 88, 1.28, 45, 82],
  [65, 93, .62, 14, 87], [77, 86, 1.45, 75, 88], [20, 18, .95, 27, 93], [55, 3, 1.32, 58, 94],
  [76, 19, .78, 80, 96], [35, 34, 1.52, 93, 89], [62, 18, .7, 12, 36], [96, 6, 1, 90, 5],
  [7, 30, 1.26, 7, 45], [53, 53, .64, 54, 57], [82, 12, 1.48, 85, 30], [22, 64, .86, 17, 68],
  [48, 82, 1.18, 50, 73], [73, 42, .72, 72, 64], [6, 87, 1.38, 8, 82], [94, 74, .68, 94, 78],
  [57, 96, 1.25, 41, 88], [84, 68, .9, 84, 93],
] as const;
