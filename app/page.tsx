...
const profileBubbleLayout = [
  [10, 6, 1.42, 12, 6], [26, 5, .72, 50, 6], [42, 7, 1.08, 88, 6], [58, 4, .64, 18, 13],
  [74, 7, 1.34, 52, 13], [90, 5, .82, 85, 13], [16, 18, 1.15, 10, 20], [32, 19, .7, 46, 20],
  [48, 17, 1.16, 90, 20], [64, 19, 1.1, 15, 27], [80, 18, 1.38, 55, 27], [94, 20, .88, 86, 27],
  [10, 32, .62, 10, 34], [24, 32, 1.3, 49, 34], [10, 41, 1, 91, 34], [24, 41, 1.22, 17, 41],
  [10, 50, .8, 57, 41], [24, 50, 1.05, 88, 41], [10, 59, .86, 12, 48], [24, 59, 1.4, 48, 48],
  [10, 68, 1.15, 84, 48], [24, 68, .9, 18, 55], [10, 77, 1.02, 55, 55], [24, 77, .62, 92, 55],
  [10, 86, 1.18, 10, 62], [24, 86, .72, 45, 62], [10, 95, .64, 87, 62], [76, 32, 1, 16, 69],
  [90, 32, .6, 54, 69], [76, 41, 1.25, 91, 69], [90, 41, 1.4, 9, 76], [76, 50, .75, 47, 76],
  [90, 50, 1.1, 86, 76], [76, 59, .72, 18, 83], [90, 59, 1.32, 58, 83], [76, 68, .78, 92, 83],
  [90, 68, 1.05, 12, 90], [76, 77, .68, 50, 90], [90, 77, 1.3, 88, 90], [76, 86, .72, 18, 96],
  [90, 86, 1.2, 55, 96], [76, 95, .82, 90, 96],
] as const;
